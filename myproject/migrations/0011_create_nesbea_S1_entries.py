...
from myproject.inputs.nesbea import nesbeas1
...
def create_entries_1(apps, schema_editor):
    ...
    edition, _ = Edition.objects.get_or_create(name="Non ESC songs Semi 1", year=0)
    for entry in nesbeas1:
        year = 0
        country = "nvm"
        artist = "nvm"
        song = "nvm"
